...
public class OptimalSort
{
    ...
    public static void main(String[] args){
        timesForDifferentMaxInsertionSortValues();
//        System.out.println("the optimal number for max insertion sort is " + findOptimalMaxInsertion());
    }
    ...
    public static void timesForDifferentMaxInsertionSortValues(){
        ...
        final int maxNumberToCheck = 40;//sizeOfArray;
...
//        if(!sorted(comparables, middlePoint+1, max)) throw new Exception("the values from min: " + (middlePoint+1) + " middlePoint: " + max + " are not sorted yet");
    ...
    public static <T extends Comparable<T>> boolean sorted(T[] a) { return sorted(a, 0, a.length-1); }
    public static <T extends Comparable<T>> boolean sorted(T[] a, int min, int max){
    ...
    private static void printArray(Object[] words){
