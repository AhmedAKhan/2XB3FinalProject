...
invokeTag('uploadForm','g',36,['action':("fileUpload"),'method':("post")],2)
printHtmlPart(11)
createClosureForHtmlPart(12, 2)
invokeTag('uploadForm','g',100,['action':("drawGraph"),'method':("post"),'class':("settingsForm"),'style':("display:none")],2)
printHtmlPart(13)
expressionOut.print(activeFile)
printHtmlPart(14)
